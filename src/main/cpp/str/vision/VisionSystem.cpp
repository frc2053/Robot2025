...
//   cameraLocations[0] =
//   robotPose.TransformBy(consts::vision::FL_ROBOT_TO_CAM); cameraLocations[1]
//   = robotPose.TransformBy(consts::vision::FR_ROBOT_TO_CAM);
//   cameraLocations[2] =
//   robotPose.TransformBy(consts::vision::BL_ROBOT_TO_CAM); cameraLocations[3]
//   = robotPose.TransformBy(consts::vision::BR_ROBOT_TO_CAM);
//   cameraLocations[4] =
